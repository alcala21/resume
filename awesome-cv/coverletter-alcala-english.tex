...
\newcommand{\company}{Quadient}
\newcommand{\location}{Wauwatosa, WI}
...
I am interested in the \openPosition~position currently available at \company. This position is a perfect match to my skill set and interests. I have a PhD in Engineering that focused on multivariate statistical modeling; and recently finished the MicroMasters in Statistics and Data Science from MIT. Furthermore, I have more than 9 years of professional experience developing algorithms in different platforms and languages.

I am a well rounded Data Scientist that can analyze, develop and adapt complex statistical models and machine learning algorithms to the specific needs of any project. I can also design experiments to tests hypothesis and answer questions that would be of value to \company. Furthermore, I am able to handle, clean, analyze and visualize large data sets, and generate automated reports. My work tools are either R, Python or SQL depending on specific project goals.

The available \openPosition~position seems like a fun and exiciting challenge, and I hope we get the opportunity to talk about it.
